    ...
    <div className='text-white flex flex-col gap-5 max-w-[95%] sm:max-w-[70%] mx-auto'>
      ...
      <div className='m-2'>
        ...
        <ul className='list-decimal px-4 text-xs sm:text-base'>
          <li>Fork the repository to your GitHub account. <a className='text-blue-400 italic underline' href="https://github.com/Phoe-nix-89/Frontend-SnapStudy">Click me</a></li>
      ...
      <div className='m-2'>
        ...
        <ul className='list-decimal px-4 text-xs sm:text-base'>
          ...
          <li>Fill out the Form from given links <a className='text-blue-400 italic underline' href="https://forms.gle/FKt7h9axUGgS7G2H8">Click me</a></li>
      ...
      <div className='m-2'>
        ...
        <h2 className=' italic text-red-500 underline text-xs sm:text-base'>
            <a href="https://github.com/Phoe-nix-89/Frontend-SnapStudy">Report here</a>
          </h2>  
      </div>
